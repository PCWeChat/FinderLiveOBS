...
#ifndef WECHAT_CRASHPAD_UTIL_WIN_GET_FUNCTION_H_
#define WECHAT_CRASHPAD_UTIL_WIN_GET_FUNCTION_H_
...
#define GET_FUNCTION_XP(library, function)                  \
    base::wechat_support_xp::internal::GetFunction<decltype(function)>( \
...
//!
//! \sa GET_FUNCTION
#define GET_FUNCTION_REQUIRED_XP(library, function)         \
    base::wechat_support_xp::internal::GetFunction<decltype(function)>( \
        library, #function, true)

#endif  // WECHAT_CRASHPAD_UTIL_WIN_GET_FUNCTION_H_
